...
<nav class="navbar navbar-expand-lg bg-body-tertiary mb-3">
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				<ul class="navbar-nav me-auto mb-2 mb-lg-0">
        			...
        			<li class="nav-item">
          				<a class="nav-link active" aria-current="page" href="#">Create a Character!</a>
        			</li>
        			<li class="nav-item">
	...
	<div class="container mt-2" style="width: 50%">
		...
		<form:form action="/characters/new" method="post" modelAttribute="newChar">
			<div class="mb-2">
			...
			<div class="mb-2">
				...
				<form:select class="form-control" path="charaClass">
					<form:option value="" label="Please select a class!"/>
			...
			<div class="mb-2">
				...
				<form:textarea class="form-control" path="backstory" />
				<form:errors class="fw-lighter fst-italic text-danger"  path="backstory"/>
			</div>
			<form:hidden path="user" value="${userID}"/>
			<form:hidden path="level" value="1"/>
